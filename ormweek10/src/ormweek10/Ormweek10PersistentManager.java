...
public class Ormweek10PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ormweek10";
	...
	private Ormweek10PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Ormweek10PersistentManager();
		}
